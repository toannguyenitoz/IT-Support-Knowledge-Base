...
# 03. Slow Windows Performance

**Section:** Windows Administration  
**Category:** Performance  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User reports slow startup, slow applications or poor device performance.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Slow Windows Performance** in a workplace IT environment.
...
- User reports slow startup, slow applications or poor device performance.
