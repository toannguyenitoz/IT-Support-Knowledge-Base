...
# 03. Microsoft 365 Service Health Check

**Section:** Microsoft 365 Administration  
**Category:** Service health  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Multiple users report issues and the admin needs to confirm whether Microsoft has an active incident.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Microsoft 365 Service Health Check** in a workplace IT environment.
...
- Multiple users report issues and the admin needs to confirm whether Microsoft has an active incident.
