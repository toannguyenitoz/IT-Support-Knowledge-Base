...
# 12. Mailbox Forwarding Check

**Section:** Microsoft 365 Administration  
**Category:** Security / mail flow  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Email may be forwarding unexpectedly or suspicious forwarding is suspected.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Mailbox Forwarding Check** in a workplace IT environment.
...
- Email may be forwarding unexpectedly or suspicious forwarding is suspected.
...
## PowerShell / Admin Checks

```powershell
Get-Mailbox -ResultSize Unlimited | Select DisplayName,ForwardingAddress,ForwardingSmtpAddress
```
