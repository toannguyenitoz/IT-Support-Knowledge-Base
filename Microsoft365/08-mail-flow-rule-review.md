...
# 08. Mail Flow Rule Review

**Section:** Microsoft 365 Administration  
**Category:** Mail flow  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Email is redirected, blocked, tagged or modified unexpectedly by a transport rule.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Mail Flow Rule Review** in a workplace IT environment.
...
- Email is redirected, blocked, tagged or modified unexpectedly by a transport rule.
