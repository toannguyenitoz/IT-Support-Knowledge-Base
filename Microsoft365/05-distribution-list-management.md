...
# 05. Distribution List Management

**Section:** Microsoft 365 Administration  
**Category:** Groups  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Users cannot send to a distribution list or membership is incorrect.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Distribution List Management** in a workplace IT environment.
...
- Users cannot send to a distribution list or membership is incorrect.
