...
# 01. Outlook Does Not Open

**Category:** Client startup / profile  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook cannot start, hangs during launch or closes immediately after opening.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Does Not Open** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook cannot start, hangs during launch or closes immediately after opening.
...
[Outlook Index](./README.md) | [Next: Outlook Crashes on Startup](./02-outlook-crashes-on-startup.md)
