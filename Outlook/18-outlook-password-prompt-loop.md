...
# 18. Outlook Password Prompt Loop

**Category:** Authentication  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook repeatedly asks for the user password.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Password Prompt Loop** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook repeatedly asks for the user password.
...
[Outlook Index](./README.md) | [Previous: Outlook Work Offline Enabled](./17-outlook-work-offline-enabled.md) | [Next: Modern Authentication Issues](./19-modern-authentication-issues.md)
