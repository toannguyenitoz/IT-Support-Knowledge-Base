...
# 41. Mail Flow Rule Issues

**Category:** Mail flow rules  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Transport rules modify, block or redirect emails unexpectedly.

---

## Overview

This article documents a practical troubleshooting approach for **Mail Flow Rule Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Transport rules modify, block or redirect emails unexpectedly.
...
[Outlook Index](./README.md) | [Previous: Message Trace Investigation](./40-message-trace-investigation.md) | [Next: SPF Failure](./42-spf-failure.md)
