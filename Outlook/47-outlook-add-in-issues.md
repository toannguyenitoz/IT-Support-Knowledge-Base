...
# 47. Outlook Add-in Issues

**Category:** Add-ins  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Third-party or Microsoft add-ins cause Outlook problems.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Add-in Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Third-party or Microsoft add-ins cause Outlook problems.
...
[Outlook Index](./README.md) | [Previous: Contact or GAL Issues](./46-contact-or-gal-issues.md) | [Next: Outlook Data File Size Issues](./48-outlook-data-file-size-issues.md)
