...
# 36. Archive Folder Issues

**Category:** Archive  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Emails are archived unexpectedly or archive folder is missing.

---

## Overview

This article documents a practical troubleshooting approach for **Archive Folder Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Emails are archived unexpectedly or archive folder is missing.
...
[Outlook Index](./README.md) | [Previous: Focused Inbox Issues](./35-focused-inbox-issues.md) | [Next: Online Archive Not Showing](./37-online-archive-not-showing.md)
