...
# 25. Send As Permission Not Working

**Category:** Permissions  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User cannot send as another mailbox.

---

## Overview

This article documents a practical troubleshooting approach for **Send As Permission Not Working** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- User cannot send as another mailbox.
...
[Outlook Index](./README.md) | [Previous: Shared Mailbox Permission Issues](./24-shared-mailbox-permission-issues.md) | [Next: Send on Behalf Permission Not Working](./26-send-on-behalf-permission-not-working.md)
