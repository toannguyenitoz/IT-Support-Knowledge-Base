...
# 28. Delegate Access Issues

**Category:** Delegation  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Delegate cannot manage calendar, inbox or meeting requests.

---

## Overview

This article documents a practical troubleshooting approach for **Delegate Access Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Delegate cannot manage calendar, inbox or meeting requests.
...
[Outlook Index](./README.md) | [Previous: Calendar Permission Issues](./27-calendar-permission-issues.md) | [Next: Teams Meeting Button Missing](./29-teams-meeting-button-missing.md)
