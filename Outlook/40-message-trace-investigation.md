...
> Purpose: Use Exchange message trace to locate mail delivery issues.

---

## Symptoms

- User reports: **Use Exchange message trace to locate mail delivery issues.**
...
```text
message-trace-investigation-old.ost
```
