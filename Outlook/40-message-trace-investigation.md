...
# 40. Message Trace Investigation

**Category:** Mail flow  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Use Exchange message trace to locate mail delivery issues.

---

## Overview

This article documents a practical troubleshooting approach for **Message Trace Investigation** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Use Exchange message trace to locate mail delivery issues.
...
[Outlook Index](./README.md) | [Previous: Quarantined Email Investigation](./39-quarantined-email-investigation.md) | [Next: Mail Flow Rule Issues](./41-mail-flow-rule-issues.md)
