...
# 48. Outlook Data File Size Issues

**Category:** Data file / performance  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Large OST/PST files cause performance and stability problems.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Data File Size Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Large OST/PST files cause performance and stability problems.
...
[Outlook Index](./README.md) | [Previous: Outlook Add-in Issues](./47-outlook-add-in-issues.md) | [Next: Mobile Outlook Sync Issues](./49-mobile-outlook-sync-issues.md)
