...
> Purpose: Large OST/PST files cause performance and stability problems.

---

## Symptoms

- User reports: **Large OST/PST files cause performance and stability problems.**
...
```text
outlook-data-file-size-issues-old.ost
```
