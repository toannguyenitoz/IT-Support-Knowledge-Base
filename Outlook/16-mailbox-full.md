...
**Scenario:** Mailbox quota prevents sending or receiving messages.

---

## Overview

This article documents a practical troubleshooting approach for **Mailbox Full** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Mailbox quota prevents sending or receiving messages.
...
[Outlook Index](./README.md) | [Previous: Emails Going to Junk](./15-emails-going-to-junk.md) | [Next: Outlook Work Offline Enabled](./17-outlook-work-offline-enabled.md)
