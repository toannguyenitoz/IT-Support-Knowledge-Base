...
# 23. Shared Mailbox Not Updating

**Category:** Shared mailbox sync  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Shared mailbox folders do not sync correctly.

---

## Overview

This article documents a practical troubleshooting approach for **Shared Mailbox Not Updating** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Shared mailbox folders do not sync correctly.
...
[Outlook Index](./README.md) | [Previous: Shared Mailbox Not Appearing](./22-shared-mailbox-not-appearing.md) | [Next: Shared Mailbox Permission Issues](./24-shared-mailbox-permission-issues.md)
