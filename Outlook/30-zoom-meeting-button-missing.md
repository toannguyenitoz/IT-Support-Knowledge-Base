...
# 30. Zoom Meeting Button Missing

**Category:** Zoom integration  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Zoom add-in is missing from Outlook.

---

## Overview

This article documents a practical troubleshooting approach for **Zoom Meeting Button Missing** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Zoom add-in is missing from Outlook.
...
[Outlook Index](./README.md) | [Previous: Teams Meeting Button Missing](./29-teams-meeting-button-missing.md) | [Next: Room Mailbox Booking Issues](./31-room-mailbox-booking-issues.md)
