...
# 50. Exchange Online Service Health Check

**Category:** Service health  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Check whether a Microsoft 365 service incident is affecting users.

---

## Overview

This article documents a practical troubleshooting approach for **Exchange Online Service Health Check** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Check whether a Microsoft 365 service incident is affecting users.
...
[Outlook Index](./README.md) | [Previous: Mobile Outlook Sync Issues](./49-mobile-outlook-sync-issues.md)
