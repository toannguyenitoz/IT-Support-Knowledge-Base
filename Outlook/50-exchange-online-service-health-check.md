...
> Purpose: Check whether a Microsoft 365 service incident is affecting users.

---

## Symptoms

- User reports: **Check whether a Microsoft 365 service incident is affecting users.**
...
```text
exchange-online-service-health-check-old.ost
```
