...
# 17. Outlook Work Offline Enabled

**Category:** Client setting  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook is accidentally set to Work Offline.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Work Offline Enabled** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook is accidentally set to Work Offline.
...
[Outlook Index](./README.md) | [Previous: Mailbox Full](./16-mailbox-full.md) | [Next: Outlook Password Prompt Loop](./18-outlook-password-prompt-loop.md)
