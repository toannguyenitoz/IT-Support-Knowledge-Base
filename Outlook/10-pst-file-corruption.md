...
# 10. PST File Corruption

**Category:** Data file  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Personal archive file cannot open or shows errors.

---

## Overview

This article documents a practical troubleshooting approach for **PST File Corruption** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Personal archive file cannot open or shows errors.
...
[Outlook Index](./README.md) | [Previous: OST File Corruption](./09-ost-file-corruption.md) | [Next: Cannot Send Emails](./11-cannot-send-emails.md)
