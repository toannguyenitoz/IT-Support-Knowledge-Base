...
> Purpose: User cannot send on behalf of another mailbox.

---

## Symptoms

- User reports: **User cannot send on behalf of another mailbox.**
...
```text
send-on-behalf-permission-not-working-old.ost
```
