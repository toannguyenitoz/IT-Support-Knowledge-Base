...
# 26. Send on Behalf Permission Not Working

**Category:** Permissions  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User cannot send on behalf of another mailbox.

---

## Overview

This article documents a practical troubleshooting approach for **Send on Behalf Permission Not Working** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- User cannot send on behalf of another mailbox.
...
[Outlook Index](./README.md) | [Previous: Send As Permission Not Working](./25-send-as-permission-not-working.md) | [Next: Calendar Permission Issues](./27-calendar-permission-issues.md)
