...
> Purpose: Search returns incomplete, outdated, or no results.

---

## Symptoms

- User reports: **Search returns incomplete, outdated, or no results.**
...
```text
outlook-search-not-working-old.ost
```
