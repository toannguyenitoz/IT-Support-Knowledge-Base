...
# 04. Outlook Search Not Working

**Category:** Search / indexing  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook search returns incomplete, outdated or no results.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Search Not Working** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook search returns incomplete, outdated or no results.
...
[Outlook Index](./README.md) | [Previous: Outlook Running Slow](./03-outlook-running-slow.md) | [Next: Outlook Shows Disconnected](./05-outlook-shows-disconnected.md)
