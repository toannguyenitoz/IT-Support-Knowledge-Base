...
> Purpose: Outlook mobile app cannot sync mail, calendar, or contacts.

---

## Symptoms

- User reports: **Outlook mobile app cannot sync mail, calendar, or contacts.**
...
```text
mobile-outlook-sync-issues-old.ost
```
