...
# 49. Mobile Outlook Sync Issues

**Category:** Mobile  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook mobile app cannot sync mail, calendar or contacts.

---

## Overview

This article documents a practical troubleshooting approach for **Mobile Outlook Sync Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook mobile app cannot sync mail, calendar or contacts.
...
[Outlook Index](./README.md) | [Previous: Outlook Data File Size Issues](./48-outlook-data-file-size-issues.md) | [Next: Exchange Online Service Health Check](./50-exchange-online-service-health-check.md)
