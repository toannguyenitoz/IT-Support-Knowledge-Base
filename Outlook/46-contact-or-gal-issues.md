...
# 46. Contact or GAL Issues

**Category:** Address book  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Global Address List or contact information is incorrect.

---

## Overview

This article documents a practical troubleshooting approach for **Contact or GAL Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Global Address List or contact information is incorrect.
...
[Outlook Index](./README.md) | [Previous: Distribution List Delivery Issues](./45-distribution-list-delivery-issues.md) | [Next: Outlook Add-in Issues](./47-outlook-add-in-issues.md)
