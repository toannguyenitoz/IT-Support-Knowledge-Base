...
**Scenario:** Rules disappear after profile changes, migration or corruption.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Rules Missing** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Rules disappear after profile changes, migration or corruption.
...
[Outlook Index](./README.md) | [Previous: Outlook Rules Not Working](./33-outlook-rules-not-working.md) | [Next: Focused Inbox Issues](./35-focused-inbox-issues.md)
