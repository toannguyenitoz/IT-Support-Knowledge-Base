...
# 22. Shared Mailbox Not Appearing

**Category:** Shared mailbox  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Shared mailbox is missing from Outlook.

---

## Overview

This article documents a practical troubleshooting approach for **Shared Mailbox Not Appearing** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Shared mailbox is missing from Outlook.
...
[Outlook Index](./README.md) | [Previous: Autodiscover Issues](./21-autodiscover-issues.md) | [Next: Shared Mailbox Not Updating](./23-shared-mailbox-not-updating.md)
