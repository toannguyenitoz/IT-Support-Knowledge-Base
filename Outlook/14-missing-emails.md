...
**Category:** Mail visibility  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Emails are not visible in Inbox or expected folders.

---

## Overview

This article documents a practical troubleshooting approach for **Missing Emails** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Emails are not visible in Inbox or expected folders.
...
[Outlook Index](./README.md) | [Previous: Emails Stuck in Outbox](./13-emails-stuck-in-outbox.md) | [Next: Emails Going to Junk](./15-emails-going-to-junk.md)
