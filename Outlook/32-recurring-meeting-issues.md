...
> Purpose: Recurring meetings are duplicated, missing, or corrupted.

---

## Symptoms

- User reports: **Recurring meetings are duplicated, missing, or corrupted.**
...
```text
recurring-meeting-issues-old.ost
```
