...
# 32. Recurring Meeting Issues

**Category:** Calendar  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Recurring meetings are duplicated, missing or corrupted.

---

## Overview

This article documents a practical troubleshooting approach for **Recurring Meeting Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Recurring meetings are duplicated, missing or corrupted.
...
[Outlook Index](./README.md) | [Previous: Room Mailbox Booking Issues](./31-room-mailbox-booking-issues.md) | [Next: Outlook Rules Not Working](./33-outlook-rules-not-working.md)
