...
# 03. Outlook Running Slow

**Category:** Performance  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook is slow when opening, switching folders, searching or sending emails.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Running Slow** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook is slow when opening, switching folders, searching or sending emails.
...
[Outlook Index](./README.md) | [Previous: Outlook Crashes on Startup](./02-outlook-crashes-on-startup.md) | [Next: Outlook Search Not Working](./04-outlook-search-not-working.md)
