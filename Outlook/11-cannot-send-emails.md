...
# 11. Cannot Send Emails

**Category:** Send issue  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User can receive mail but cannot send messages.

---

## Overview

This article documents a practical troubleshooting approach for **Cannot Send Emails** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- User can receive mail but cannot send messages.
...
[Outlook Index](./README.md) | [Previous: PST File Corruption](./10-pst-file-corruption.md) | [Next: Cannot Receive Emails](./12-cannot-receive-emails.md)
