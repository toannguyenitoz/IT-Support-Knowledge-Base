...
> Purpose: Outlook opens briefly and then crashes or shows application errors.

---

## Symptoms

- User reports: **Outlook opens briefly and then crashes or shows application errors.**
...
```text
outlook-crashes-on-startup-old.ost
```
