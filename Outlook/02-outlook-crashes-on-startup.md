...
# 02. Outlook Crashes on Startup

**Category:** Client stability  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook opens briefly and then crashes or shows application errors.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Crashes on Startup** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook opens briefly and then crashes or shows application errors.
...
[Outlook Index](./README.md) | [Previous: Outlook Does Not Open](./01-outlook-does-not-open.md) | [Next: Outlook Running Slow](./03-outlook-running-slow.md)
