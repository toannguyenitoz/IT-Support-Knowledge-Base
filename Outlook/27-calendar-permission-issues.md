...
# 27. Calendar Permission Issues

**Category:** Calendar  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User cannot view or manage another calendar.

---

## Overview

This article documents a practical troubleshooting approach for **Calendar Permission Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- User cannot view or manage another calendar.
...
[Outlook Index](./README.md) | [Previous: Send on Behalf Permission Not Working](./26-send-on-behalf-permission-not-working.md) | [Next: Delegate Access Issues](./28-delegate-access-issues.md)
