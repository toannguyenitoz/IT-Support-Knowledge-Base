...
> Purpose: Users cannot send to or receive from distribution lists.

---

## Symptoms

- User reports: **Users cannot send to or receive from distribution lists.**
...
```text
distribution-list-delivery-issues-old.ost
```
