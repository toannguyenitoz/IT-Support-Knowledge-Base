...
# 45. Distribution List Delivery Issues

**Category:** Distribution groups  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Users cannot send to or receive from distribution lists.

---

## Overview

This article documents a practical troubleshooting approach for **Distribution List Delivery Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Users cannot send to or receive from distribution lists.
...
[Outlook Index](./README.md) | [Previous: DMARC Failure](./44-dmarc-failure.md) | [Next: Contact or GAL Issues](./46-contact-or-gal-issues.md)
