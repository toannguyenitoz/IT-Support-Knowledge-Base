...
# 31. Room Mailbox Booking Issues

**Category:** Resource mailbox  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Meeting rooms cannot be booked or auto-accept incorrectly.

---

## Overview

This article documents a practical troubleshooting approach for **Room Mailbox Booking Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Meeting rooms cannot be booked or auto-accept incorrectly.
...
[Outlook Index](./README.md) | [Previous: Zoom Meeting Button Missing](./30-zoom-meeting-button-missing.md) | [Next: Recurring Meeting Issues](./32-recurring-meeting-issues.md)
