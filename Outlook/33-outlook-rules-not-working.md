...
> Purpose: Inbox rules do not run or move emails incorrectly.

---

## Symptoms

- User reports: **Inbox rules do not run or move emails incorrectly.**
...
```text
outlook-rules-not-working-old.ost
```
