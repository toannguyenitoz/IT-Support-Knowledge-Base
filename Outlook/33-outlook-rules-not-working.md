...
# 33. Outlook Rules Not Working

**Category:** Rules  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Inbox rules do not run or move emails incorrectly.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Rules Not Working** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Inbox rules do not run or move emails incorrectly.
...
[Outlook Index](./README.md) | [Previous: Recurring Meeting Issues](./32-recurring-meeting-issues.md) | [Next: Outlook Rules Missing](./34-outlook-rules-missing.md)
