...
# 13. Emails Stuck in Outbox

**Category:** Send queue  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Messages remain in Outbox and do not send.

---

## Overview

This article documents a practical troubleshooting approach for **Emails Stuck in Outbox** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Messages remain in Outbox and do not send.
...
[Outlook Index](./README.md) | [Previous: Cannot Receive Emails](./12-cannot-receive-emails.md) | [Next: Missing Emails](./14-missing-emails.md)
