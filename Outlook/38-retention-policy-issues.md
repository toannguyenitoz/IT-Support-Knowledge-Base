...
# 38. Retention Policy Issues

**Category:** Retention  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Emails are deleted or moved due to retention policies.

---

## Overview

This article documents a practical troubleshooting approach for **Retention Policy Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Emails are deleted or moved due to retention policies.
...
[Outlook Index](./README.md) | [Previous: Online Archive Not Showing](./37-online-archive-not-showing.md) | [Next: Quarantined Email Investigation](./39-quarantined-email-investigation.md)
