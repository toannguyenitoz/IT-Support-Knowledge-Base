...
# 39. Quarantined Email Investigation

**Category:** Defender  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Expected emails are held in Microsoft Defender quarantine.

---

## Overview

This article documents a practical troubleshooting approach for **Quarantined Email Investigation** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Expected emails are held in Microsoft Defender quarantine.
...
[Outlook Index](./README.md) | [Previous: Retention Policy Issues](./38-retention-policy-issues.md) | [Next: Message Trace Investigation](./40-message-trace-investigation.md)
