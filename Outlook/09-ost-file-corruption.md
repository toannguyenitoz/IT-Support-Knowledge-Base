...
> Purpose: Offline cache file causes sync, startup, or missing email issues.

---

## Symptoms

- User reports: **Offline cache file causes sync, startup, or missing email issues.**
