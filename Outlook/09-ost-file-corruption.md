...
# 09. OST File Corruption

**Category:** Data file  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Offline cache file causes sync, startup or missing email issues.

---

## Overview

This article documents a practical troubleshooting approach for **OST File Corruption** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Offline cache file causes sync, startup or missing email issues.
...
[Outlook Index](./README.md) | [Previous: Outlook Profile Corruption](./08-outlook-profile-corruption.md) | [Next: PST File Corruption](./10-pst-file-corruption.md)
