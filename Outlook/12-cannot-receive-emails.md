...
# 12. Cannot Receive Emails

**Category:** Receive issue  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User can send mail but cannot receive messages.

---

## Overview

This article documents a practical troubleshooting approach for **Cannot Receive Emails** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- User can send mail but cannot receive messages.
...
[Outlook Index](./README.md) | [Previous: Cannot Send Emails](./11-cannot-send-emails.md) | [Next: Emails Stuck in Outbox](./13-emails-stuck-in-outbox.md)
