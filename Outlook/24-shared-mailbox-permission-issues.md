...
> Purpose: User cannot access or send from shared mailbox.

---

## Symptoms

- User reports: **User cannot access or send from shared mailbox.**
...
```text
shared-mailbox-permission-issues-old.ost
```
