...
# 24. Shared Mailbox Permission Issues

**Category:** Permissions  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User cannot access or send from a shared mailbox.

---

## Overview

This article documents a practical troubleshooting approach for **Shared Mailbox Permission Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- User cannot access or send from a shared mailbox.
...
[Outlook Index](./README.md) | [Previous: Shared Mailbox Not Updating](./23-shared-mailbox-not-updating.md) | [Next: Send As Permission Not Working](./25-send-as-permission-not-working.md)
