...
# 20. MFA Issues in Outlook

**Category:** MFA  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook cannot complete MFA or sign-in approval.

---

## Overview

This article documents a practical troubleshooting approach for **MFA Issues in Outlook** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook cannot complete MFA or sign-in approval.
...
[Outlook Index](./README.md) | [Previous: Modern Authentication Issues](./19-modern-authentication-issues.md) | [Next: Autodiscover Issues](./21-autodiscover-issues.md)
