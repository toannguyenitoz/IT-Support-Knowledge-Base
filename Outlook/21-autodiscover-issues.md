...
# 21. Autodiscover Issues

**Category:** Autodiscover  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook cannot automatically configure mailbox settings.

---

## Overview

This article documents a practical troubleshooting approach for **Autodiscover Issues** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook cannot automatically configure mailbox settings.
...
[Outlook Index](./README.md) | [Previous: MFA Issues in Outlook](./20-mfa-issues-in-outlook.md) | [Next: Shared Mailbox Not Appearing](./22-shared-mailbox-not-appearing.md)
