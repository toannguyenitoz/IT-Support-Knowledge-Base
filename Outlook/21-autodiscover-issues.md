...
> Purpose: Outlook cannot automatically configure mailbox settings.

---

## Symptoms

- User reports: **Outlook cannot automatically configure mailbox settings.**
