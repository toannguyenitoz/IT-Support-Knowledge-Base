...
> Purpose: Outlook does not pass the loading profile screen.

---

## Symptoms

- User reports: **Outlook does not pass the loading profile screen.**
...
```text
outlook-stuck-on-loading-profile-old.ost
```
