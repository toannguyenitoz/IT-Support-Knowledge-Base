...
# 06. Outlook Stuck on Loading Profile

**Category:** Profile / cache  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Outlook does not pass the loading profile screen.

---

## Overview

This article documents a practical troubleshooting approach for **Outlook Stuck on Loading Profile** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Outlook does not pass the loading profile screen.
...
[Outlook Index](./README.md) | [Previous: Outlook Shows Disconnected](./05-outlook-shows-disconnected.md) | [Next: Outlook Safe Mode Troubleshooting](./07-outlook-safe-mode-troubleshooting.md)
