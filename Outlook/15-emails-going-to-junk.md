...
# 15. Emails Going to Junk

**Category:** Spam filtering  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Legitimate emails are delivered to Junk Email.

---

## Overview

This article documents a practical troubleshooting approach for **Emails Going to Junk** in an Outlook / Exchange Online / Microsoft 365 environment.
...
- Legitimate emails are delivered to Junk Email.
...
[Outlook Index](./README.md) | [Previous: Missing Emails](./14-missing-emails.md) | [Next: Mailbox Full](./16-mailbox-full.md)
