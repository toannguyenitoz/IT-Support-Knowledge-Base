...
# 02. MFA Troubleshooting

**Section:** Entra ID / Azure AD  
**Category:** MFA  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User cannot complete MFA or does not receive MFA prompts.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **MFA Troubleshooting** in a workplace IT environment.
...
- User cannot complete MFA or does not receive MFA prompts.
