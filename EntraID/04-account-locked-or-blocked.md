...
# 04. Account Locked or Blocked

**Section:** Entra ID / Azure AD  
**Category:** Account status  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User account is locked, blocked or unable to authenticate.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Account Locked or Blocked** in a workplace IT environment.
...
- User account is locked, blocked or unable to authenticate.
...
```powershell
Get-MgUser -UserId user@domain.com | Select DisplayName,AccountEnabled
```
...
[Back to Entra ID / Azure AD Index](./README.md) | [Back to top](#top)
