...
# 10. Hybrid Identity Sync Issue

**Section:** Entra ID / Azure AD  
**Category:** Hybrid identity  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** On-premises AD changes are not appearing in Entra ID.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Hybrid Identity Sync Issue** in a workplace IT environment.
...
- On-premises AD changes are not appearing in Entra ID.
