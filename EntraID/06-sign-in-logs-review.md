...
# 06. Sign-in Logs Review

**Section:** Entra ID / Azure AD  
**Category:** Logs  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Technician needs to review sign-in logs to identify failed authentication reason.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Sign-in Logs Review** in a workplace IT environment.
...
- Technician needs to review sign-in logs to identify failed authentication reason.
