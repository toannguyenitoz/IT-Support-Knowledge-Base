...
# 05. Teams Audio or Microphone Issue

**Section:** Microsoft Teams  
**Category:** Audio / device  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** User cannot hear audio or microphone does not work in Teams.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Teams Audio or Microphone Issue** in a workplace IT environment.
...
- User cannot hear audio or microphone does not work in Teams.
...
[Back to Microsoft Teams Index](./README.md) | [Back to top](#top)
