...
# 06. Teams Camera Issue

**Section:** Microsoft Teams  
**Category:** Video / device  
**Audience:** IT Support, Service Desk, Desktop Support, Junior System Administrator  
**Scenario:** Camera does not work in Teams meetings.

---

## Overview

This article provides a practical troubleshooting and documentation approach for **Teams Camera Issue** in a workplace IT environment.
...
- Camera does not work in Teams meetings.
